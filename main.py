...
SINIF_LISTESI = [
    "ELİF SENA ALGIN", "ZELİHA BÜYÜKDOĞAN", "ÜMRAN LALEK", "EFE SAÇMALI", "YASİN ERDOĞAN",
    "MUSTAFA EFE BAYSAL", "NASIF EMRE GÖZÜKÜÇÜK", "ALTAN ÖZTÜRK", "YİĞİT ALİ MERT",
    "ZEYNEP BEREKETLİ", "ONUR KAAN ÖZYURT", "ECE SU KAYA", "EGEHAN KUDDAR", "ELA YILDIRIM",
    "ELİSA BAL", "FADİME HİRANUR AYKÜL", "HATİCE KARAKAŞ", "HAVVA SİZGEN", "MAHMUD SAMİ SIÇRAMAZ",
    ...
    "SIDIKA SILA DAĞ", "ALİ BATIN ÇETİN", "PERİHAN CİVELEK", "ELİF ÜLKÜ AKDENİZ", "DİLANUR SARIKAYA",
    "EMİR ŞAHİN", "SÜLEYMAN KUŞCU", "BERKAY ALP SİVRİDAĞ", "SILA TOPAL", "AHMED HAYRİ KUŞÇUTOPAL",
    "MEHMET ÇAĞLAYAN HARPUT", "BERRİN ERVA GÜLDEN", "TAHA ERDOĞAN", "ŞEHED MUSTAFA", "ESMA SAKMEN",
