...
SINIF_LISTESI = [
"ELİF SENA ALGIN", "ÖĞRENCİ A.B.", "BİLİM İNSANI-1", "İBNİ SİNA","ALİ KUŞÇU", "AZİZ SANCAR", "CAHİT ARF", "PİRİ REİS","MİMAR SİNAN", "KATİP ÇELEBİ", 
    "ULUĞ BEY", "OKTAY SİNANOĞLU", "DENEME KULLANICISI", "ELİSA BAL",   "BARIŞ MANÇO", "KEMAL SUNAL", "NEŞET ERTAŞ", "AŞIK VEYSEL",  "FATİH SULTAN MEHMET", 
    "EMEL SAYIN", "ADİLE NAŞİT", "ŞENER ŞEN", "HALİDE EDİB",  "YAŞAR KEMAL","FAZIL SAY",  "NAİM SÜLEYMANOĞLU", "NASRETTİN HOCA", "METE GAZOZ", "ANONİM KULLANICI-1", 
    "MİSAFİR ÖĞRENCİ"
]
